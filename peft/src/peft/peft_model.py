...
from .tuners import LoraModel, SparseFTModel, BottleneckModel, PrefixEncoder, PromptEmbedding, PromptEncoder
from .utils import (
    ...
    **Attributes**:
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        if isinstance(self.peft_config, PromptLearningConfig):
            ...
            if self.peft_config.peft_type == PeftType.SPARSEFT:
                self.base_model = SparseFTModel(peft_config, model)
    ...
    def from_pretrained(cls, model, model_id, **kwargs):
        ...
        if getattr(model, "hf_device_map", None) is not None:
            ...
            if model.peft_config.peft_type == PeftType.LORA or model.peft_config.peft_type == PeftType.BOTTLENECK or model.peft_config.peft_type == PeftType.SPARSEFT:
